...
> driver is detected the app forces Mesa's EGL (llvmpipe) instead, which is stable and
...
[Apache-2.0](LICENSE), matching [Nexis](https://github.com/rwetz/Nexis), whose design system `_design/` is extracted from.
